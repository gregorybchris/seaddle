 ...
 *
 * On by default, and on for almost everybody: a rider who has just added a
 * segment is looking for what comes after it, and finding it means a pan and a
 * zoom they did not ask to do. But that camera move is also the site taking the
 * map away from someone who deliberately put it somewhere — zoomed into the
